...
# 4. Add headers
# Define the header content with the dynamic version
HEADER="/*
 * CampaignBay
 ...
 *
 * Source Code (Root): https://github.com/dipta-sdd/campaignbay/tree/$VERSION/
 * Source Code (Admin): https://github.com/dipta-sdd/campaignbay/tree/$VERSION/src/admin
 *
...
for file in "${FILES[@]}"; do
    if [ -f "$file" ]; then
        ...
        # Create a temporary file with the header followed by the original content
