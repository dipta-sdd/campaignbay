...
if ( ! class_exists( 'WPAB_CB_Campaign_Manager' ) ) {
	/**
	 ...
	 */
	class WPAB_CB_Campaign_Manager {

		/**
		 * The single instance of the class.
		 *
		 * @since 1.0.0
		 * @var   WPAB_CB_Campaign_Manager
		 * @access private
		 */
...
// ... (keep the wpab_cb_campaign_manager function)  

if ( ! function_exists( 'wpab_cb_campaign_manager' ) ) {
	/**
	 * Returns the single instance of the Campaign Manager.
	 *
	 * @since 1.0.0
	 * @return WPAB_CB_Campaign_Manager
	 */
	function wpab_cb_campaign_manager() {
		return WPAB_CB_Campaign_Manager::get_instance();
	}
}