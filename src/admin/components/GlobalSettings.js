...
const GlobalSettings = ({ globalSettings, setGlobalSettings, isSaving, handleSave }) => (
    <div className="wpab-cb-settings-tab">
        ...
        <SettingCard title="Performence & Caching">
            ...
            <button className="wpab-button-secondery">
        ...
        <div className='wpab-button-con-card'>
            <button className='isLoading' disabled={isSaving} onClick={() => handleSave({ ...globalSettings })}>
                <Save className="icon" />
                Save Changes
            </button>
        </div>
