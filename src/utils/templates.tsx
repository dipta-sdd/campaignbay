...
const templates: Template[] = [
  {
    ...
    campaign_data: {
      ...
      settings: {
        ...
        message_format: "FLASH SALE: {discount_value} OFF!",
      },
    },
    markdown:
    ...
    campaign_data: {
      ...
      settings: {
        ...
        cart_quantity_message_format:
          "You saved {saved_amount} by buying in bulk!",
      },
    },
    markdown:
  ...
  },
  {
    ...
    campaign_data: {
      ...
      settings: {
        message_format:
          "Early Bird: Get {discount_value} Off! Only {remaining} left.",
      },
    },
    markdown:
  ...
  },
  {
    ...
    campaign_data: {
      ...
      settings: {
        display_as_regular_price: false,
        message_format: "Weekend Special: Save {discount_value} now!",
      },
    },
    markdown:
  ...
  },
  {
    ...
    campaign_data: {
      ...
      settings: {
        display_as_regular_price: false,
        message_format: "Clearance Sale: {discount_value} Off",
      },
    },
    markdown:
  ...
  },
  {
    ...
    campaign_data: {
      ...
      settings: {
        enable_quantity_table: true,
        apply_as: "line_total",
        cart_quantity_message_format: "You've unlocked {saved_amount} savings!",
      },
    },
    markdown:
