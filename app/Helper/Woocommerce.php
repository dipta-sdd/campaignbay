...
class Woocommerce
{
    ...
    //     }
    //     if (is_a($product, 'WC_Product')) {
    //         return apply_filters('campaignbay_get_product_from_cart_item', $product, $cart_item);
    //     }
    //     return false;
    // }
    ...
    //             return apply_filters('campaignbay_get_price', $price, $product);
    //         }
    //     return false;
    // }
    ...
    //         }
    //     return apply_filters('campaignbay_get_product_categories', $categories, $product, $variant);
    // }
    ...
    //             return apply_filters('campaignbay_price_suffix', $product->get_price_suffix($price), $product, $price, $discount_prices);
    //         }
    //     return NULL;
    // }
    ...
    //         });
    //         self::$custom_taxonomies = apply_filters('campaignbay_get_custom_taxonomies', self::$custom_taxonomies);
    //     }
    //     return self::$custom_taxonomies;
    // }
    ...
    //     } else {
    //         $html = self::format_price($min_price) . ' - ' . self::format_price($max_price);
    //     }

    //     return apply_filters('campaignbay_format_sale_price_range', $html, $min_price, $max_price, $original_html);
    // }
    ...
    //         if(apply_filters('campaignbay_do_recalculate_total', $recalculate_total)){
    ...
    //         }
    //     }
    //     return apply_filters('campaignbay_get_cart', $cart);
    // }
    ...
    // {
    //     if (apply_filters('campaignbay_recalculate_shipping_package',true) && function_exists('WC')) {
    //         if(isset(WC()->cart) && WC()->cart != null) {
    ...
    //     }
    //     return apply_filters('campaignbay_get_cart_items', $cart_items, $cart);
    // }
    ...
    //             }
    //         }
    //         return apply_filters('campaignbay_get_cart_subtotal', $subtotal);
    //     }
    ...
    //     return apply_filters('campaignbay_line_item_subtotal', $line_subtotal, $cart_item, $tax_display_type);
    // }
    ...
    //     return apply_filters('campaignbay_get_price_including_tax', $price, $product, $original_price);
    // }
    ...
    //     return apply_filters('campaignbay_get_price_excluding_tax', $price, $product, $original_price);
    // }
    ...
    //     return apply_filters('campaignbay_get_banner_position_events', $banner_hooks);
    // }
    ...
    //         if (!empty($id)) {
    //             $product_id = Woocommerce::get_product_parent_id($id);
    //             if (empty($product_id)) {
    //                 return $id;
    //             } else {
    //                 return $product_id;
    ...
    //         return apply_filters('campaignbay_get_on_sale_product_ids', $on_sale_product_ids);
    //     }
    ...
    //         }
    //     }
    //     return apply_filters('campaignbay_get_cart_total_quantities', $quantity, $cart_items);
    // }
    ...
    //         }
    //     return apply_filters('campaignbay_get_price_html', $html, $product);
    // }
    ...
    //     if (is_numeric($product)) $product = self::get_product($product);
    //     $product_id = self::get_product_id($product);
    //     if(self::product_type_is($product, 'variation')){
    //         $attributes = (array) self::getProductAttributes($product);
    //         $modify_count = apply_filters('campaignbay_variation_title_modify_count', 2);
    //         if (count($attributes) > $modify_count) {
    //             $variation_parent_id = self::get_product_parent_id($product);
